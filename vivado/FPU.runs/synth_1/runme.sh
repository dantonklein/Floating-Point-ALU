...
HD_PWD='C:/Users/klein/Documents/projects/Floating-Point-ALU/vivado/FPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log floating_point_alu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source floating_point_alu.tcl
