...
HD_PWD='C:/Users/klein/Documents/projects/Floating-Point-ALU/vivado/FPU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log floating_point_alu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source floating_point_alu.tcl -notrace
